...
class Interactive(abc.ABC):
    ...
    def _update(self, dt):
        ...
        while self._sim_time < self._current_time:
            ...
            if not self._sync or act is not None:
                ...
                #Get the inpout states as images
    ...
    def _on_close(self):
        ...
        #Image gray-scale Array
        final_image_array = np.empty((len(self.states),),dtype=object)
        for i in range(len(self.states)):
            final_image_array[i] = self.states[i]
        ...
        dataset = np.array((final_image_array,final_action_array))
        #np.save("/Users/sankalpssss/Documents/marioenv/mario/mario2/Data final/Image/Level2/L2_Session1",dataset)
